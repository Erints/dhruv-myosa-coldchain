...
<p align="center">
  <img src="dhruv-cover.jpg" width="800"><br/>
  <i>Figure 1: DHRUV Node hardware setup integrated inside the MYOSA enclosure alongside the design schematic notebook, showing live OLED status.</i>
</p>

<p align="center">
  <img src="dhruv-dashboard.jpg" width="800"><br/>
  <i>Figure 2: PHC Base Station Web Dashboard connected live to node ASHA-KL05, rendering the Chain Integrity Index (75%), live multi-sensor telemetry chart, and active tamper alerts.</i>
</p>

<p align="center">
  <img src="dhruv-firebase.jpg" width="800"><br/>
  <i>Figure 3: Firebase Realtime Database cloud backend running side-by-side with the web client, streaming live telemetry coordinates and breach events in real time.</i>
</p>

### Videos

[▶ Watch DHRUV Demonstration Video](dhruv-demonstration-video.mp4)
...
├── dhruv-cover.jpg                   # Cover & Hardware Image
├── dhruv-dashboard.jpg               # Dashboard Screenshot
├── dhruv-firebase.jpg                # Firebase RTDB Sync View
├── dhruv-demonstration-video.mp4     # Local Demo MP4 Video
├── dhruv-myosa-coldchain.md          # Official MYOSA Submission File
└── README.md                         # Copy of Submission File for GitHub Preview
